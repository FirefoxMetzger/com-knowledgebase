---
{
  ...
  "id": "43e6b8c6-1177-4d58-abb2-1e6e265447ac",
  "message_id": "<20260418.150221.744b3678@mta26>",
  "thread_id": "fdf197a5-6e84-404d-add5-90ff16c6d4cb",
  "direction": "inbound",
  "from": "turingpost@mail.beehiiv.com",
  "to": "sally.anderson@inkboxmail.com",
  "subject": "\"Intention is What We Need\": Neeru Khosla on the Future of Education and\tLearning with AI",
  "created_at": "2026-04-18T15:02:25.910913+00:00",
  "fetched_at": "2026-04-22T18:31:12.913735+00:00",
  "is_read": false,
...
----------_“Attention is what taught the machines. But now, in this AI world, we need to have intention and judgment._**_ Intention is what we need._**_”_
...
_“Just knowing that the answer is right or wrong doesn’t tell anybody anything.”_

It is most useful when it helps surface the learner’s internal process. A question like _“How does the sun burn if there’s no oxygen in space?”_ is not just a cute moment of curiosity – it reveals a specific misunderstanding that a good tutor can work with. This is the logic behind Flexi, CK-12’s AI tutor, which Neeru says has already been used by tens of millions of students and has processed more than 150 million questions. No one needs automation for its own sake. New tools give us the ability to trace learning more deeply than standardized testing ever could.

View image: (https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,format=auto,onerror=redirect,quality=80/uploads/asset/file/dc96b180-7106-459c-a39a-1a4a14fbaa4e/Screenshot_2026-04-18_at_9.41.54_AM.png?t=1776519740)
Caption: 
...
As I keep saying, AI literacy is extremely important, and this conversation is a great way to learn how to move from fear to understanding. [Please watch it and share it →](https://youtu.be/oNJtSBtqXrY)

Youtube: AI Could Change Education Forever – Neeru Khosla Explains Why (https://youtu.be/oNJtSBtqXrY)

----------
_Subscribe to our __[YouTube channel](https://www.youtube.com/watch?v=mq_V6zAjsSI)__, or listen the interview on __[Spotify](https://open.spotify.com/show/2SQxCURLX8tKzv7IarPhYM)__ / __[Apple](https://podcasts.apple.com/us/podcast/inference-by-turing-post/id1811089330)_


----------_We prepared a transcript for reference, but __[the full experience is in the video](https://www.youtube.com/watch?v=6BAqgT3qe98)__. And as always: like and comment. It helps us grow on YouTube and bring you more insights._

**Ksenia:**
**Today I’m very honored to speak with ****[Neeru Khosla.](https://info.ck12.org/team)**** She is an entrepreneur and philanthropist known for her work in education and social impact. She is the co-founder of CK-12 Foundation, which provides free, customizable learning materials to students and teachers worldwide.**
...
When OpenAI suddenly reached enormous adoption in a very short time, it was clear something major was happening. A lot of people were afraid: _students will cheat_, _machines will replace us_, and so on. I was afraid as well. But I also noticed something important: prompting itself is a learning tool.
...
So over the last three years, we built on top of everything we had already done in learning science, concept maps, and knowledge connections. Two and a half years ago, we introduced [Flexi](https://info.ck12.org/flexi-overview), our student tutor. Today we have over 50 million students using it.

View image: (https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,format=auto,onerror=redirect,quality=80/uploads/asset/file/f082a33b-9de0-4559-8d82-959134327ace/Screenshot_2026-04-18_at_9.15.13_AM.png?t=1776518128)
Caption: 
...
From the beginning, I told the team that we had to categorize and tag the questions students were asking. Many are procedural: _help me solve this_, _define this_, _help me understand this_. Those are fine.

But the questions that really matter are the ones that reveal thinking. For example: _How does the sun burn when there’s no oxygen in space?_ That’s a wonderful question from a young learner. You immediately see the misconception: the child is assuming the sun “burns” through combustion, when in fact it’s nuclear fusion.
...
“Sometimes I would sit down next to a child who was off in a corner alone and just ask, “What’s going on?” And often that child didn’t need someone to do the work for them. They just needed someone to say: _You’re doing fine. Keep going. Let me help if you’re stuck.'_
...
**Neeru:**
One more thing. In machine learning, people say _attention is all you need_. That’s what taught the machines. But for humans – for education, for society – attention is not enough.

We need intention. We need judgment.

Why am I learning this? Why does it matter? It cannot just be _let AI do it_. That’s what I would say.
...
I learned to read English through Dr. Seuss and Archie comics. Later, _The Hobbit_ influenced me a lot. And then _Man’s Search for Meaning_ by Viktor Frankl had a very deep impact on me.
...
And I also love music. I love _Hamilton_. That line – _I’m not throwing away my shot_ – really resonates with me. I’m still not giving away my shot. I’m going to keep taking it.
...
Leave a comment (https://www.turingpost.com/p/neeru?_bhlid=4eaa234680798ad3bdb45514b5705f029891f88c&jwt_token={{jwt_token}}?comments=true)

**Further reading**

* CK-12 Foundation: [https://www.ck12.org/](https://www.ck12.org/)

* Flexi by CK-12: [https://www.ck12.org/flexi/](https://www.ck12.org/flexi/)

* Free FlexBooks and adaptive learning resources: [https://www.ck12.org/student/](https://www.ck12.org/student/)

* AI Literacy – How Much Do We Know About AI? [https://www.turingpost.com/p/fod91](https://www.turingpost.com/p/fod91)


———

You are reading a plain text version of this post. For the best experience, copy and paste this link in your browser to view the post online:
https://www.turingpost.com/p/neeru
